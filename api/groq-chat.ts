...
/**
 * Core POST handler (used by Vite dev middleware). Kept in this file so Vercel deploys
 * one serverless bundle without cross-file ESM resolution issues under `/var/task`.
 */
